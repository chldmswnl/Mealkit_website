...
app.post('/signup',(req,res)=>{
    ...
    {
        passed=false;
        validation.email="must start with number or character and also contain '@'";
    }

    if(!validatePassword(password))
    {
        passed=false;
        validation.password="must be 6 to 20 and at least one digit, uppercase, lowercase";
    }

    if(passed)
    {
        const key="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";
